...
"""------------------------------------------------
#Section1 - gweichtete Kanten u. shortest path mit Dijkstra
...
"""-----------------------------------------------
#Section2 - erzeugt in diesem fall 3 .png
...
"""-----------------------------------------------
#Section3 - write graph 0 with default paramenters (see objective_function_experiments.py)
...
"""----------------------------------------------
#Section4 - write graph 1 with default paramenters (see objective_function_experiments.py)
...
#arboList = arborescenses.get_arborescencr_list(graph1)
"""
